...
assert.equal(translate("illustrationLoading", "zh"), "正在加载插图…");
assert.equal(translate("illustrationLoading", "en"), "Loading illustration…");
assert.equal(translate("illustrationLoadFailed", "zh"), "无法读取插图");
assert.equal(translate("illustrationLoadFailed", "en"), "Unable to load illustration");
